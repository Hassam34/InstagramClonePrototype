            ...
            <View style={styles.MainContainer}>
                <View style={styles.backgroundImageStyle}>
                    ...
                    <View style={{ marginTop: 7 }}>
                        <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => this.props.navigation.navigate('HelpSign')}>
                    ...
                    <View>
                        <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => this.props.navigation.navigate('Welcome')}>
